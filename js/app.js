window.addEventListener("load", () => {
   if ('serviceWorker' in navigator) {
	...
	const accu_api = `${proxy}https://dataservice.accuweather.com/currentconditions/v1/260803?apikey=nXP46AASmAknwg4UkDqPCriY1Yldqon5&details=true`;
	...
	const accu_forcast_api = `${proxy}https://dataservice.accuweather.com/forecasts/v1/daily/1day/260803?apikey=nXP46AASmAknwg4UkDqPCriY1Yldqon5&details=true&metric=true`;
